...
object ActivityRepository {
    private val activities = listOf(
        ...
        GoalActivity(
            ...
            socialPreference = SocialPreference.ALONE,
            maxTimeMinutes = 60,
            interests = listOf(Interest.WRITING)
        ),
        ...
        GoalActivity(
            ...
            socialPreference = SocialPreference.ALONE,
            maxTimeMinutes = 45,
            interests = listOf(Interest.CRAFTS)
        ),
        ...
        GoalActivity(
            ...
            socialPreference = SocialPreference.ALONE,
            maxTimeMinutes = 60,
            interests = listOf(Interest.PHOTOGRAPHY)
        ),
        ...
        GoalActivity(
            ...
            socialPreference = SocialPreference.ALONE,
            maxTimeMinutes = 45,
            interests = listOf(Interest.GAMING, Interest.TRAVEL)
        ),
        ...
        GoalActivity(
            ...
            socialPreference = SocialPreference.ALONE,
            maxTimeMinutes = 60,
            interests = listOf(Interest.GARDENING)
        ),
        ...
        GoalActivity(
            ...
            socialPreference = SocialPreference.ALONE,
            maxTimeMinutes = 60,
            interests = listOf(Interest.NATURE, Interest.PHOTOGRAPHY)
        ),
        // Social
        GoalActivity(
            name = "Call a friend",
        ...
        GoalActivity(
            ...
            socialPreference = SocialPreference.ALONE,
            maxTimeMinutes = 15,
            interests = listOf(Interest.MINDFULNESS)
        ),
        ...
        GoalActivity(
            ...
            socialPreference = SocialPreference.ALONE,
            maxTimeMinutes = 30,
            interests = listOf(Interest.TECHNOLOGY)
        ),
        ...
        GoalActivity(
            ...
            socialPreference = SocialPreference.ALONE,
            maxTimeMinutes = 30,
            interests = listOf(Interest.NATURE, Interest.TECHNOLOGY)
        ),
        ...
        GoalActivity(
            ...
            socialPreference = SocialPreference.EITHER,
            maxTimeMinutes = 120,
            interests = listOf(Interest.EXPLORATION)
        ),
        ...
        GoalActivity(
            ...
            socialPreference = SocialPreference.EITHER,
            maxTimeMinutes = 90,
            interests = listOf(Interest.FOOD)
        ),
